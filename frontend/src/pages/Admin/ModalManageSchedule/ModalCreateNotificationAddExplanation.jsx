...
import { callCreateNotification, callCreateNotificationAddFileExplanation, callGetNotification, callGetNotificationAddFileExplanation } from "../../../../services/api";
const { RangePicker } = DatePicker;

const ModalCreateNotificationAddExplanation = (props) => {
    const { openModalCreateNotificationAddExplanation, setOpenModalCreateNotificationAddExplanation } = props
    ...
    const handleCancel = () => {
        setOpenModalCreateNotificationAddExplanation(false)
    }
    const onFinish = async (values) => {
        const getExist = await callGetNotificationAddFileExplanation()
    ...
    return (
        <>
            <Modal title="Tạo thông báo nộp hồ sơ thuyết minh"
                open={openModalCreateNotificationAddExplanation}
            ...
            >
                <Form
                    ...
                    fields={[
                        {
                            name: ["name"],
                            value: 'Thông báo nộp hồ sơ thuyết minh',
                        },
                    ]}
                >
                    <Form.Item
...
export default ModalCreateNotificationAddExplanation